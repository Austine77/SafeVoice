...
CORS_ORIGINS=https://SafeVoice-worldwide.onrender.com
...
git remote add origin  https://github.com/austine77/safevoice.git
...
```powershell
git remote set-url origin https://github.com/austine77/safevoice.git
git push -u origin main
```
