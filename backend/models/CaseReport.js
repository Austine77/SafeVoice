...
const contactSchema = new mongoose.Schema({
  ...
  phoneCountryDialCode: { type: String, trim: true, default: '' },
  phoneCountryIso2: { type: String, trim: true, uppercase: true, default: '' },
  phoneCountryName: { type: String, trim: true, default: '' },
  phoneNationalNumber: { type: String, trim: true, default: '' },
}, { _id: false });
