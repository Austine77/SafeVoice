...
export function ReportStep1({ goTo, reportDraft, setReportDraft }: Props) {
  return (
    <section className="card">
      ...
      <div className="button-row"><button className="btn btn-primary" onClick={() => goTo('report2')}>Next</button><button className="btn btn-secondary" onClick={() => goTo('home')}>Cancel</button></div>
    </section>
  );
}

export function ReportStep2({ goTo, reportDraft, setReportDraft }: Props) {
  return (
    <section className="card">
      <ReportStepper current={2} />
      <h3>Where did this happen?</h3>
      <p>Location is optional for safety. The user should always be able to skip this step.</p>
      <div className="option-list">
      ...
      <div className="button-row"><button className="btn btn-secondary" onClick={() => setReportDraft((prev) => ({ ...prev, location: 'Not shared' }))}>Skip for safety</button><button className="btn btn-primary" onClick={() => goTo('report3')}>Next</button><button className="btn btn-secondary" onClick={() => goTo('report1')}>Back</button></div>
    </section>
  );
}

export function ReportStep3({ goTo, reportDraft, setReportDraft }: Props) {
  return (
    <section className="card">
      ...
      <div className="button-row"><button className="btn btn-primary" onClick={() => goTo('report4')}>Next</button><button className="btn btn-secondary" onClick={() => goTo('report2')}>Back</button></div>
    </section>
  );
}

export function ReportStep4({ goTo, reportDraft, setReportDraft }: Props) {
  ...
  return (
    <section className="card">
      ...
      <p>Optional uploads can help, but the survivor should be able to continue without them.</p>
      ...
      <div className="button-row"><button className="btn btn-primary" onClick={() => goTo('report5')}>Next</button><button className="btn btn-secondary" onClick={() => goTo('report3')}>Back</button></div>
    </section>
  );
}
...
export function ReportStep5({ goTo, reportDraft, setReportDraft, onSubmittedCase, onTrackCaseId }: FinalStepProps) {
  ...
  return (
    <section className="card">
      ...
      <p>Anonymous by default. The user controls whether to share contact details.</p>
      <div className="option-list">
      ...
      <div className="button-row"><button className="btn btn-primary" onClick={submitReport} disabled={isSubmitting}>{isSubmitting ? 'Submitting...' : 'Submit Report'}</button><button className="btn btn-secondary" onClick={() => goTo('report4')}>Back</button></div>
    </section>
  );
}
